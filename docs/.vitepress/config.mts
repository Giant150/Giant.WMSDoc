            ...
            },
            {
                ...
                items: [
                    ...
                    { text: '移动端功能介绍' },
                    {
                        ...
                        collapsed: true,
                        items: [
                            { text: 'P2P', link: '/feture/rf/action/AGVscheduling' },
                            { text: 'P2Z', link: '/feture/rf/action/AGVpointtozone' },
                            { text: '空托出库', link: '/feture/rf/action/trayout' },
                            { text: '空托入库', link: '/feture/rf/action/trayin' },
                            { text: '空托绑定', link: '/feture/rf/action/trayinit' },
                            { text: '到货确认', link: '/feture/rf/action/asnconfirmlist' },
                            { text: '收货', link: '/feture/rf/action/receiptbyorderlist' },
                            { text: '直收', link: '/feture/rf/action/receiptzhishou' },
                            { text: '上架', link: '/feture/rf/action/putaway' },
                            { text: '配货拣货', link: '/feture/rf/action/orderbystep' },
                            { text: '波次配货', link: '/feture/rf/action/wavebystep' },
                            { text: '拣货', link: '/feture/rf/action/pickmanual' },
                            { text: '直发', link: '/feture/rf/action/shipzhifa' },
                            { text: '确认拣货', link: '/feture/rf/action/pickway' },
                            { text: '整托移库', link: '/feture/rf/action/moveloc' },
                            { text: '托盘移库', link: '/feture/rf/action/trayrfmove' },
                            { text: '库存移库', link: '/feture/rf/action/moveinv' },
                            { text: '整托直发', link: '/feture/rf/action/shipbytray' },
                            { text: '手动补货', link: '/feture/rf/action/replenal' },
                            { text: '补货确认', link: '/feture/rf/action/replenalconfirm' },
                            { text: '质检确认', link: '/feture/rf/action/qualityconfirm' },
                            { text: '料架叫料', link: '/feture/rf/action/shipstdbyBC' },
                            { text: '料架入库', link: '/feture/rf/action/trayinbyStd' },
                            { text: '盘点出库', link: '/feture/rf/action/checktrayout' },
                    ...
                    },
                    {
                        ...
                        collapsed: true,
                        items: [
                            { text: '物料', link: '/feture/rf/data/Skulist' },
                            { text: '库存', link: '/feture/rf/data/inventory' },
                            { text: '往来单位', link: '/feture/rf/data/storer' },
                            { text: '托盘', link: '/feture/rf/data/tray' },
                            { text: '库位', link: '/feture/rf/data/loc' },
                            { text: '库存台账', link: '/feture/rf/data/ledger' },
                            { text: '批次', link: '/feture/rf/data/lot' },
                            { text: '任务管理', link: '/feture/rf/data/task' },
                    ...
                    },
                    {
                        ...
                        collapsed: true,
                        items: [
                            { text: '物料类型', link: '/feture/rf/rpt/skutype' },
                            { text: '货主库存', link: '/feture/rf/rpt/storerinv' },
                            { text: '上架区域', link: '/feture/rf/rpt/putawayinv' },
                            { text: '区域库存', link: '/feture/rf/rpt/area' },
                            { text: '任务统计', link: '/feture/rf/rpt/task' },
                        ]
                    },
                ]
            },
